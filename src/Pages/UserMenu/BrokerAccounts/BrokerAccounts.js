...
const BrokerAccounts = () => {
    ...
    return (
        <div className="card">
            ...
            <div style={{display: "flex"}}>
                    ...
                    <div className="card-header"
                        ...
                        <div style={{width: 400, display: 'flex', justifyContent: 'flex-end'}}>
                            <button className={'icon-button'}
                                    onClick={() => setShowCounterPartyModal(!showCounterPartyModal)}>Add
                            </button>
                        </div>
                    </div>
                    <table>
                        ...
                        <tbody>
                        {apiNotSupportedBrokers && apiNotSupportedBrokers.length > 0 ? (
                            ...
                            <tr key={data.id}>
                                ...
                                <td className="action-buttons">
                                    ...
                                    <button className="icon-button" onClick={() => deleteBroker(data.id)}
                                            title={'Delete'}>
                                        <BsTrash size={20}/>
                                    </button>
                                </td>
                        ...
                        <tr>
                            <td colSpan="7" style={{ textAlign: "center" }}>No institutions were added.</td>
                        </tr>
                    )}
                        </tbody>
                    </table>
                ...
                <div className="table-container" style={{width: '100%'}}>
                    <div className="card-header"
                        ...
                        <div style={{width: 400, display: 'flex', justifyContent: 'flex-end'}}>
                            <button className={'icon-button'}
                                    onClick={() => setShowNewAccountModal(!showNewAccountModal)}>Add
                            </button>
                        </div>
                    </div>
                    <table>
            ...
            <NewCounterParty show={showCounterPartyModal}
                             close={() => setShowCounterPartyModal(!showCounterPartyModal)}/>
